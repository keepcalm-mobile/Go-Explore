...
class Article extends ScrollablePage {
    constructor(props) {
        const itemId = props.navigation.state.params.itemId;
        props.getItem(itemId, screens.Article);
    ...
    render() {
        ...
        return (
            <ScrollView contentContainerStyle={s.container} onScroll={this.onScroll}>
                <ItemHeader type={type} data={header} onPress={this.onDirectionPress} hasDirection={!!this.props.data.location}/>
                <TabView
